...
g++ -g -Wall filterv.cpp powerv.cpp momenfield.cpp powermomen.cpp filter_neg.cpp powerspec.cpp tide.cpp smooth_fs.cpp recon.cpp vfield.cpp -L /opt/fftw-3.3.3/lib -I /opt/fftw-3.3.3/include -lfftw3 -lm -L/opt/gsl-1.15-gcc-4.4.6/lib -I/opt/gsl-1.15-gcc-4.4.6/include -lgsl -lgslcblas -o tides00
