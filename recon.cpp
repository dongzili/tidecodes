...
char outPath[80]={"/home/zhm/dongzi/tidez1/3dtidenew/00k3d_noisy_z1_rpar15.bin"};
...
//cout<<deltars2[i];
        ...
        shearz[i]=(2.*pow(deltars3[i],2)-pow(deltars1[i],2)-pow(deltars2[i],2))/3.; //correct the paper
    }
//===================================================================
    fftw_free(deltars1);
    fftw_free(deltars2);  
